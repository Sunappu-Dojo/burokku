...
interface BeforeInstallPromptEvent extends Event {
    /**
     * An array of `DOMString` items containing the platforms on which the
     * event was dispatched. This is provided for user agents that want
     * to present a choice of versions to the user such as “web” or
     * “play” which would allow the user to chose between a web
